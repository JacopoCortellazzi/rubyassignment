...
public class Test extends java.lang.Object {
    ...
    public static class _PyInner extends PyFunctionTable implements PyRunnable {
        ...
        private static void initConstants() {
            ...
            s$6 = Py.newString("\\s*move\\([0-9]+\\,[0-9]+\\)\012*");
            s$7 = Py.newString("\\s*turn_cw\\([0-9]+\\)\012*");
            s$8 = Py.newString("\\s*turn_ccw\\([0-9]+\\)\012*");
            ...
            s$25 = Py.newString("/home/paulsson/Documents/School/DYPL/Assignments/Assignment 1/Attachments/Test.py");
            funcTable = new _PyInner();
            c$0_calculateRadian = Py.newCode(1, new String[] {"self"}, "/home/paulsson/Documents/School/DYPL/Assignments/Assignment 1/Attachments/Test.py", "calculateRadian", false, false, funcTable, 0, null, null, 0, 17);
            c$1_calculateAngle = Py.newCode(2, new String[] {"self", "angle", "tmp"}, "/home/paulsson/Documents/School/DYPL/Assignments/Assignment 1/Attachments/Test.py", "calculateAngle", false, false, funcTable, 1, null, null, 0, 17);
            c$2_penDown = Py.newCode(1, new String[] {"self"}, "/home/paulsson/Documents/School/DYPL/Assignments/Assignment 1/Attachments/Test.py", "penDown", false, false, funcTable, 2, null, null, 0, 17);
            c$3_penUp = Py.newCode(1, new String[] {"self"}, "/home/paulsson/Documents/School/DYPL/Assignments/Assignment 1/Attachments/Test.py", "penUp", false, false, funcTable, 3, null, null, 0, 17);
            c$4_moveForward = Py.newCode(1, new String[] {"self"}, "/home/paulsson/Documents/School/DYPL/Assignments/Assignment 1/Attachments/Test.py", "moveForward", false, false, funcTable, 4, null, null, 0, 17);
            c$5_moveBackward = Py.newCode(1, new String[] {"self"}, "/home/paulsson/Documents/School/DYPL/Assignments/Assignment 1/Attachments/Test.py", "moveBackward", false, false, funcTable, 5, null, null, 0, 17);
            c$6_move = Py.newCode(2, new String[] {"self", "l"}, "/home/paulsson/Documents/School/DYPL/Assignments/Assignment 1/Attachments/Test.py", "move", false, false, funcTable, 6, null, null, 0, 17);
            c$7_turnCw = Py.newCode(2, new String[] {"self", "l"}, "/home/paulsson/Documents/School/DYPL/Assignments/Assignment 1/Attachments/Test.py", "turnCw", false, false, funcTable, 7, null, null, 0, 17);
            c$8_turnCcw = Py.newCode(2, new String[] {"self", "l"}, "/home/paulsson/Documents/School/DYPL/Assignments/Assignment 1/Attachments/Test.py", "turnCcw", false, false, funcTable, 8, null, null, 0, 17);
            c$9_put = Py.newCode(2, new String[] {"self", "l"}, "/home/paulsson/Documents/School/DYPL/Assignments/Assignment 1/Attachments/Test.py", "put", false, false, funcTable, 9, null, null, 0, 17);
            c$10_actionPerformed = Py.newCode(2, new String[] {"self", "event"}, "/home/paulsson/Documents/School/DYPL/Assignments/Assignment 1/Attachments/Test.py", "actionPerformed", false, false, funcTable, 10, null, null, 0, 17);
            c$11_regMatching = Py.newCode(2, new String[] {"self", "code", "r", "times", "partOfString", "x", "wholeString", "numbers"}, "/home/paulsson/Documents/School/DYPL/Assignments/Assignment 1/Attachments/Test.py", "regMatching", false, false, funcTable, 11, null, null, 0, 17);
            c$12_forMethod = Py.newCode(4, new String[] {"self", "code", "x", "times", "i", "tmp"}, "/home/paulsson/Documents/School/DYPL/Assignments/Assignment 1/Attachments/Test.py", "forMethod", false, false, funcTable, 12, null, null, 0, 17);
            c$13_myMatching = Py.newCode(2, new String[] {"self", "code"}, "/home/paulsson/Documents/School/DYPL/Assignments/Assignment 1/Attachments/Test.py", "myMatching", false, false, funcTable, 13, null, null, 0, 17);
            c$14_setDYPL = Py.newCode(2, new String[] {"self", "obj"}, "/home/paulsson/Documents/School/DYPL/Assignments/Assignment 1/Attachments/Test.py", "setDYPL", false, false, funcTable, 14, null, null, 0, 17);
            c$15_MyJythonApp = Py.newCode(0, new String[] {}, "/home/paulsson/Documents/School/DYPL/Assignments/Assignment 1/Attachments/Test.py", "MyJythonApp", false, false, funcTable, 15, null, null, 0, 16);
            c$16_main = Py.newCode(0, new String[] {}, "/home/paulsson/Documents/School/DYPL/Assignments/Assignment 1/Attachments/Test.py", "main", false, false, funcTable, 16, null, null, 0, 16);
        }
        ...
        private static PyObject move$7(PyFrame frame) {
            ...
            frame.getlocal(0).__setattr__("steps", frame.getglobal("int").__call__(frame.getlocal(1).__getitem__(i$1)));
            frame.getlocal(0).invoke("calculateAngle", frame.getglobal("int").__call__(frame.getlocal(1).__getitem__(i$13)));
        ...
        private static PyObject turnCw$8(PyFrame frame) {
            ...
            frame.getlocal(0).invoke("calculateAngle", frame.getglobal("int").__call__(frame.getlocal(1)));
            return Py.None;
        }
        
        private static PyObject turnCcw$9(PyFrame frame) {
            frame.setlocal(1, frame.getlocal(1).invoke("strip", s$17));
            frame.getlocal(0).invoke("calculateAngle", frame.getglobal("int").__call__(frame.getlocal(1)).__neg__());
            return Py.None;
        }
        ...
        private static PyObject forMethod$13(PyFrame frame) {
            ...
            while ((t$1$PyObject = t$0$PyObject.__iternext__()) != null) {
                ...
                while (frame.getlocal(1).__nonzero__()) {
                    frame.getlocal(0).invoke("regMatching", frame.getlocal(5));
        ...
        private static PyObject myMatching$14(PyFrame frame) {
            frame.getglobal("eval").__call__(frame.getlocal(1));
            return Py.None;
        }
    ...
    public static class MyJythonApp extends JythonTranslater.Jtrans implements org.python.core.PyProxy, org.python.core.ClassDictInit {
        ...
        public void __initProxy__(Object[] args) {
            Py.initProxy(this, "Test", "MyJythonApp", args, Test.jpy$packages, Test.jpy$proxyProperties, null, new String[] {"Test"});
        }
    ...
    public static void moduleDictInit(PyObject dict) {
        dict.__setitem__("__name__", new PyString("Test"));
    ...
    public static void main(String[] args) throws java.lang.Exception {
        ...
        Py.runMain(Test._PyInner.class, newargs, Test.jpy$packages, Test.jpy$mainProperties, null, new String[] {"Test"});
    }
